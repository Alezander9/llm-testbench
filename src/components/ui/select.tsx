...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & {
    variant?: "primary" | "secondary" | "disabled" | "viewOnly";
  }
>(({ className, children, variant = "primary", ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md px-3 py-2 text-sm ring-offset-background [&>span]:line-clamp-1",
      variant === "primary" &&
  ...
  >
    {children}
    {variant !== "disabled" && variant !== "viewOnly" && (
